        ...
        <div class="rounded-xl bg-gray-600 px-16 py-10 shadow-lg max-sm:px-8 bg-opacity-50 backdrop-blur-md">
            <div class="text-black">
                <div class="mb-8 flex flex-col items-center">
                    ...
                    <span class="text-gray-300">{{ __('login') }} {{ __('system') }}</span>
                </div>
                <form method="post" enctype="multipart/form-data" id="LoginForm">
                    ...
                    <div class="mb-4 text-lg">
                        <input
                            ...
                            type="text" name="mdusname" placeholder="{{ __('username') }}" />
                    </div>

                    <div class="mb-4 text-lg">
                        <input
                            class="rounded-3xl border-none bg-white bg-opacity-50 px-6 py-2 text-black text-start text-inherit placeholder-black shadow-lg outline-none backdrop-blur-md"
                            type="Password" name="mduspassword" placeholder="{{ __('password') }}" />
                    </div>
                    ...
                    <div class="mt-8 flex justify-center text-lg text-black">
                        <button type="submit"
                            class="rounded-3xl bg-[#66ccff] bg-opacity-50 px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-blue-800">{{ __('login') }}</button>
                    </div>
                </form>
