        ...
        <div class="md:flex no-wrap md:-mx-2 ">
            ...
            <div class="w-full md:w-3/12 md:mx-2">
                ...
                <div class="bg-white p-3 border-t-4 border-green-400">
                    ...
                    <h1 class="text-gray-900 font-bold text-xl leading-8 my-1" id="us-fullname">Fullname</h1>
                    <h3 class="text-gray-600 font-lg text-semibold leading-6" id="us-username">Username</h3>
                ...
                <div class="bg-white p-3 hover:shadow">
                    ...
                    <div class="grid grid-cols-3" id="similarUser-list">
                        {{--
                            ...
                            <a href="/users/user20" class="text-main-color">user20</a>
                        </div>
                        --}}
                    </div>
