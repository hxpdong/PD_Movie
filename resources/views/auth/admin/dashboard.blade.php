                ...
                <header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
                    <div class="flex items-center">
                        ...
                        <div class="relative mx-4 lg:mx-0">
                            ...
                            <input class="bg-gray-600 text-white p-4 w-32 pl-10 pr-4 rounded-md form-input sm:w-64 focus:border-indigo-600"
                    ...
                    <div class="flex items-center">
                        ...
                        <div x-data="{ dropdownOpen: false }" class="relative">
                            <button @click="dropdownOpen = ! dropdownOpen"
                                ...
                                <img class="object-cover w-full h-full" src="/img/avt-user.png" alt="Your avatar">
                            </button>
                            ...
                            <div x-show="dropdownOpen"
                                ...
                                <a class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">
                                    <form method="POST" action="/logout">
                                        @csrf
                                        <button type="submit" class="w-full font-medium">Logout</button>
                                    </form>
                                </a>
                            </div>
                        </div>
