        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" id="modalUpdateMovieForm">
                    @method('PUT')
                    <div>
                        <button class='font-bold' type="button" onclick="changeInfoDivState()">Thông tin phim</button>
                    </div>
                    <div id="infoDiv">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="grid grid-cols-1">
                                <label class="block mb-2 md:mb-0 text-sm font-medium text-gray-900 dark:text-white">Chọn
                                    thể
                                    loại</label>
                            ...
                            <div>
                                <div>
                                    <label for="dtDirector"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Đạo diễn
                                        (cách
                                        nhau bởi
                                        dấu phẩy)</label>
                        ...
                        <div class="grid gap-4 grid-cols-2 md:grid-cols-4">
                            ...
                            <div>
                                <label for="dtTypePoster"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kiểu
                                    poster</label>
                    ...
                    <div id="chapterDiv">
                        <div class="px-6 pb-6 lg:px-8">
                            ...
                            <button id="btnAddNewChapter" type="button"
